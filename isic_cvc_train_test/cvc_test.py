...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', default='/home/cqut/Data/medical_seg_data/CVC_ClinicDB/',type=str, help='the path of dataset')
    parser.add_argument('--csvfile', default='src/CVC_ClinicDB/test_train_data.csv',type=str, help='two columns [image_id,category(train/test)]')
    parser.add_argument('--model',default='save_models/best_model_0.04179143580523404_epoch_185_0.9189500310204246.pth', type=str, help='the path of model')
